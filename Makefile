...
GLOBAL_DEFS = $(SYSCLK) $(MEMS_CONF)  USE_STDPERIPH_DRIVER STM32F429_439xx USE_STM32F429I_DISCO  USE_EMBEDDED_PHY USE_USB_OTG_HS # HSE_VALUE=8000000 # RTC_CLOCK_SOURCE_LSE
