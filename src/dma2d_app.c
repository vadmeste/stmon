...
/*   NVIC_DMA2DInitStructure.NVIC_IRQChannel = DMA2D_IRQn;
  ...
  NVIC_DMA2DInitStructure.NVIC_IRQChannel = DMA2D_IRQn;
  NVIC_DMA2DInitStructure.NVIC_IRQChannelPreemptionPriority = 10;
  NVIC_DMA2DInitStructure.NVIC_IRQChannelSubPriority = 10;
  NVIC_DMA2DInitStructure.NVIC_IRQChannelCmd = ENABLE;
  NVIC_Init(&NVIC_DMA2DInitStructure); 
  ...
  DMA2D_ITConfig(DMA2D_IT_CE, ENABLE);
  DMA2D_ITConfig(DMA2D_IT_CTC, ENABLE);
  DMA2D_ITConfig(DMA2D_IT_CAE, ENABLE);

  DMA2D_ITConfig(DMA2D_IT_TW, ENABLE);
  DMA2D_ITConfig(DMA2D_IT_TC, ENABLE);
  DMA2D_ITConfig(DMA2D_IT_TE, ENABLE);
